		...
		<footer className={styles.siteFooter}>
			<div className={styles.container}>
				<div className={styles.footerLeft}>
					<a className={styles.ftLogo} href="/">
						<h1>Petscare</h1>
					</a>
					...
					<div className={styles.ftSocial}>
						<a
							href="https://www.facebook.com/profile.php?id=61553103295303"
							target="_blank"
							rel="noreferrer"
						>
							<img src={facebook} alt="" className={styles.ic} />
						</a>
						<a href="https://www.instagram.com/hunde24service/" target="_blank" rel="noreferrer">
							<img src={instagram} alt="" className={styles.ic} />
						</a>
						<a
							href="https://www.youtube.com/channel/UCaozidmPEF99KGAJlB8opAg"
							target="_blank"
							rel="noreferrer"
						>
							<img src={youtube} alt="" className={styles.ic} />
						</a>
					</div>
				</div>
